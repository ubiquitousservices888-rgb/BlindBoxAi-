...
export const UES_NETWORK_DISCLOSURE =
  "AI-assisted community and partnership prompt from Ubiquitious Enlightened Services; participation does not guarantee business results.";
...
export function buildUesNetworkCandidate({ date = new Date() } = {}) {
  ...
  const candidate = {
    ...
    feedbackPlan: {
      ...
      rule: "Use measured response patterns to improve future prompts; never fabricate demand, endorsements, scarcity, revenue, or guaranteed outcomes.",
    },
    disclosures: {
...
export function buildUesNetworkPreview(candidate) {
  ...
  return [
    ...
    "- No fabricated demand, endorsements, scarcity, revenue, or guaranteed outcomes.",
