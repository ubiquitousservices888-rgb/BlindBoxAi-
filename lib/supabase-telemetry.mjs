...
export async function recordProviderEvidence(evidence, { ownerCode, fetchImpl = fetch } = {}) {
  if (!ownerCode) throw new Error("Owner authorization is required");
  return callTelemetry({ type: "provider_evidence", evidence }, { ownerCode, fetchImpl });
}
