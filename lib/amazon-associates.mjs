...
export function buildAmazonSearchUrl(offerId) {
  ...
  return buildAmazonSpecialLink(offer.searchQuery);
}

export function buildAmazonSpecialLink(searchQuery) {
  const query = String(searchQuery ?? "").trim();
  if (!query) throw new Error("Amazon search query is required");
