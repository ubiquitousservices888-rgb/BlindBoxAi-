...
export const AUDIENCE_PRICE_DISCLOSURE = "Viewer answers are opinions, not completed-sale evidence or verified market value.";
...
export function generateVideoScript(product, date = new Date()) {
  ...
  const audienceQuestion = product.videoMode === AUDIENCE_PRICE_MODE
    ? `No matching completed sales were verified for this exact card. What would you personally pay for it? ${AUDIENCE_PRICE_DISCLOSURE}`
    : null;
